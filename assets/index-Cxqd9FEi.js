(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const o of document.querySelectorAll('link[rel="modulepreload"]'))r(o);new MutationObserver(o=>{for(const a of o)if(a.type==="childList")for(const s of a.addedNodes)s.tagName==="LINK"&&s.rel==="modulepreload"&&r(s)}).observe(document,{childList:!0,subtree:!0});function n(o){const a={};return o.integrity&&(a.integrity=o.integrity),o.referrerPolicy&&(a.referrerPolicy=o.referrerPolicy),o.crossOrigin==="use-credentials"?a.credentials="include":o.crossOrigin==="anonymous"?a.credentials="omit":a.credentials="same-origin",a}function r(o){if(o.ep)return;o.ep=!0;const a=n(o);fetch(o.href,a)}})();const y="/web-itariff-temporal/assets/administracion-vYPTVi05.png",h="/web-itariff-temporal/assets/auditoria-C_GTYAOt.png",L="/web-itariff-temporal/assets/auditorias-B3SJ__9P.png",T="/web-itariff-temporal/assets/capacitacion-CsrjnlC6.png",M="/web-itariff-temporal/assets/coaching-ujdCFTqG.png",O="/web-itariff-temporal/assets/propuestavalor-B9E15WG1.png",N="/web-itariff-temporal/assets/background-Cbs3T__1.jpg",I="/web-itariff-temporal/assets/logoBlue-dssebgsH.png",k="/web-itariff-temporal/assets/anexo24-v7jDiE3Y.png",A="/web-itariff-temporal/assets/anexo30-D1gmqjdD.png",E="/web-itariff-temporal/assets/cumplimientoIcon-DC0OwPRt.png",R="/web-itariff-temporal/assets/logo-DRPNcPwc.png",P="/web-itariff-temporal/assets/background2-be7nb_CX.jpg",j="/web-itariff-temporal/assets/AutorizacionesIcon-CkFcCwkm.png",D="/web-itariff-temporal/assets/ImpuestosAduanerosIcon-BnG-EJgj.png",$="/web-itariff-temporal/assets/ExpedientesPedimentosIcon-CTCQ7K0k.png",B="/web-itariff-temporal/assets/ValidacionSaldosIcon-xXUUPp7P.png",V="/web-itariff-temporal/assets/ControlInventariosAnexo24Icon--5yKdtQL.png",q="/web-itariff-temporal/assets/ProcessAnexo30Icon-CFfdq5QB.png",z="/web-itariff-temporal/assets/LegalActivosFijosIcon-C-heLG1D.png",H="/web-itariff-temporal/assets/HeroVideo-eHnhy-Bw.mp4",w=[{title:"COACHING",description:"Se obtiene el conocimiento para la gestión de su departamento de comercio exterior."},{title:"PROPUESTA DE VALOR",description:"En I TARIFF estamos comprometidos a llevar las mejores prácticas del cumplimiento aduanero mexicano a tu empresa."},{title:"ADMINISTRACIÓN DE ANEXO 24.",description:"Se administra, audita y controla la obligación de demostrar los retornos de las mercancías importadas."},{title:"ADMINISTRACIÓN DE ANEXO 30.",description:"Se administra y supervisa la obligación de demostrar el pago del IVA de las importaciones temporales a través de sus retornos."}],f=[{title:"Autorizaciones",iconPath:j,description:"Evitar la suspensión del padrón de importadores, de los beneficios de los programas IMMEX, PROSEC, Regla 8va, de los Tratados de Libre Comercio, la Certificación de IVA & IEPS y de Empresa Confiable (OEA)."},{title:"Impuestos Aduaneros",iconPath:D,description:"Evitar el pago indebido por no conocer la aplicación total de las preferencias arancelarías de los Tratados de Libre Comercio, PROSEC y Regla 8va en las mercancías de importación."},{title:"Expedientes de Pedimentos",iconPath:$,description:"Evitar el pago de multas por no contar con los documentos necesarios para demostrar la Importación, Exportación, Cambio de Régimen, Regularización, Transferencia, Destrucción o Donación de las mercancías en facultades de comprobación de las Autoridades fiscales u aduaneras."},{title:"Validación de Saldos",iconPath:B,description:"Revisamos y validamos los saldos y reportes generados por su sistema contra la base de datos de la autoridad (SAT/AGA)."},{title:"Control de inventarios Anexo 24",iconPath:V,description:"Evitar el pago de multas por no contar con el sistema conforme a la ley y multas por no demostrar el retorno de las mercancías importadas temporalmente en facultades de comprobación de las autoridades aduaneras."},{title:"Anexo 30",iconPath:q,description:"Evitar la suspensión de la certificación de IVA y el pago de dicho impuesto evitando impactos económicos importantes de flujo de efectivo debido a su pago por operación."},{title:"Legal Estancia de Activos fijos",iconPath:z,description:"Evitar la duplicación de pago de impuestos, multas y embargo de mercancías al no poder demostrar la legal estancia en el país en facultades de comprobación de las autoridades aduaneras."}],F=`
      ...
      <div class="relative w-full overflow-hidden">
        <div id="horizontal-carousel-wrapper" class="relative">
            <div id="horizontal-carousel" class="flex transition-transform duration-500 ease-in-out">
                ...
                ${u("BoltIcon","INDUSTRIA ELÉCTRICA")}
                ${u("TruckIcon","INDUSTRIA DE AUTO PARTES AUTOMOTRICES")}
                ${u("CogIcon","INDUSTRIA DEL ACERO")}
                ${u("HomeIcon","COMERCIALIZACIÓN PARA INDUSTRIA Y VIVIENDA")}
                ${u("ScissorsIcon","INDUSTRIA TEXTIL")}
                ${u("ToolIcon","COMERCIALIZACIÓN DE MAQUINARIA Y HERRAMENTAL")}
  ...
  <div class="flex justify-center items-start lg:h-full lg:py-12">
    <div class="scroll-reveal opacity-0 translate-y-12 transition-all duration-700 ease-out bg-white p-8 rounded-xl shadow-2xl max-w-md w-full border border-gray-200"> 
      ...
      <div class="flex justify-center mb-4">
        <img src="${O}" alt="Propuesta de Valor Imagen" class="w-24 h-24 object-cover rounded-full"/>
      </div>
...
`,W=`
  <div class="grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8 h-full py-12 w-full mx-auto">
    ...
    <div class="scroll-reveal opacity-0 translate-y-12 transition-all duration-700 ease-out service-card cursor-pointer p-6 shadow-xl rounded-lg bg-white hover:shadow-2xl border border-gray-200 text-center flex flex-col justify-between items-center" data-service-id="anexo30">
        <div>
            <img src="${A}" alt="Anexo 30" class="w-16 h-16 object-cover mx-auto mb-4"/>
    ...
    <div class="md:col-span-2 flex justify-center mt-4"> 
        <div class="scroll-reveal opacity-0 translate-y-12 transition-all duration-700 ease-out service-card cursor-pointer p-6 shadow-xl rounded-lg bg-white hover:shadow-2xl border border-gray-200 text-center flex flex-col justify-between items-center" data-service-id="cumplimiento"> 
            <div>
                <img src="${E}" alt="Gestión Integral" class="w-16 h-16 object-cover rounded-full mx-auto mb-4"/>
            ...
            ${f.map((e,t)=>`
                <div class="scroll-reveal opacity-0 translate-y-12 transition-all duration-700 ease-out bg-white p-6 rounded-lg shadow-lg border border-gray-200">
                    <div class="flex items-start space-x-4 mb-3">
                        <span class="w-10 h-10 flex items-center justify-center rounded-full bg-sky-900 text-white font-bold text-lg flex-shrink-0">${t+1}</span>
                        <div>
  ...
  <header class="sticky top-0 z-50 bg-white shadow-lg">
    <nav class="container mx-auto p-7 flex justify-between items-center relative">
      ...
      <a href="#inicio" class="nav-link flex items-center py-1 hidden md:block absolute left-4 top-1/2 transform -translate-y-1/2">
        <img src="${I}" alt="ITARIFF Logo" class="h-12 w-auto">
      </a>
      
      <a href="#inicio" class="nav-link mobile-logo-link block md:hidden flex items-center">
        <img src="${I}" alt="ITARIFF Logo Móvil" class="h-15 w-auto"> 
      </a>
...
`;function u(e,t){let n="";switch(e){case"BoltIcon":n='<path stroke-linecap="round" stroke-linejoin="round" d="m3.75 13.5 10.5-11.25L12 10.5h8.25L9.75 21.75 12 13.5H3.75Z" />';break;case"TruckIcon":n='<path stroke-linecap="round" stroke-linejoin="round" d="M8.25 18.75a1.5 1.5 0 0 1-3 0m3 0a1.5 1.5 0 0 0-3 0m3 0h6m-9 0H3.375a1.125 1.125 0 0 1-1.125-1.125V14.25m17.25 4.5a1.5 1.5 0 0 1-3 0m3 0a1.5 1.5 0 0 0-3 0m3 0h1.125c.621 0 1.129-.504 1.09-1.124a17.902 17.902 0 0 0-3.213-9.193 2.056 2.056 0 0 0-1.58-.86H14.25M16.5 18.75h-2.25m0-11.177v-.958c0-.568-.422-1.048-.987-1.106a48.554 48.554 0 0 0-10.026 0 1.106 1.106 0 0 0-.987 1.106v7.635m12-6.677v6.677m0 4.5v-4.5m0 0h-12" />';break;case"CogIcon":n='<path stroke-linecap="round" stroke-linejoin="round" d="M4.5 12a7.5 7.5 0 0 0 15 0m-15 0a7.5 7.5 0 1 1 15 0m-15 0H3m16.5 0H21m-1.5 0H12m-8.457 3.077 1.41-.513m14.095-5.13 1.41-.513M5.106 17.785l1.15-.964m11.49-9.642 1.149-.964M7.501 19.795l.75-1.3m7.5-12.99.75-1.3m-6.063 16.658.26-1.477m2.605-14.772.26-1.477m0 17.726-.26-1.477M10.698 4.614l-.26-1.477M16.5 19.794l-.75-1.299M7.5 4.205 12 12m6.894 5.785-1.149-.964M6.256 7.178l-1.15-.964m15.352 8.864-1.41-.513M4.954 9.435l-1.41-.514M12.002 12l-3.75 6.495" />';break;case"HomeIcon":n='<path stroke-linecap="round" stroke-linejoin="round" d="m2.25 12 8.954-8.955c.44-.439 1.152-.439 1.591 0L21.75 12M4.5 9.75v10.125c0 .621.504 1.125 1.125 1.125H9.75v-4.875c0-.621.504-1.125 1.125-1.125h2.25c.621 0 1.125.504 1.125 1.125V21h4.125c.621 0 1.125-.504 1.125-1.125V9.75M8.25 21h8.25" />';break;case"ScissorsIcon":n='<path stroke-linecap="round" stroke-linejoin="round" d="m7.848 8.25 1.536.887M7.848 8.25a3 3 0 1 1-5.196-3 3 3 0 0 1 5.196 3Zm1.536.887a2.165 2.165 0 0 1 1.083 1.839c.005.351.054.695.14 1.024M9.384 9.137l2.077 1.199M7.848 15.75l1.536-.887m-1.536.887a3 3 0 1 1-5.196 3 3 3 0 0 1 5.196-3Zm1.536-.887a2.165 2.165 0 0 0 1.083-1.838c.005-.352.054-.695.14-1.025m-1.223 2.863 2.077-1.199m0-3.328a4.323 4.323 0 0 1 2.068-1.379l5.325-1.628a4.5 4.5 0 0 1 2.48-.044l.803.215-7.794 4.5m-2.882-1.664A4.33 4.33 0 0 0 10.607 12m3.736 0 7.794 4.5-.802.215a4.5 4.5 0 0 1-2.48-.043l-5.326-1.629a4.324 4.324 0 0 1-2.068-1.379M14.343 12l-2.882 1.664" />';break;case"ToolIcon":n='<path stroke-linecap="round" stroke-linejoin="round" d="M11.42 15.17 17.25 21A2.652 2.652 0 0 0 21 17.25l-5.877-5.877M11.42 15.17l2.496-3.03c.317-.384.74-.626 1.208-.766M11.42 15.17l-4.655 5.653a2.548 2.548 0 1 1-3.586-3.586l6.837-5.63m5.108-.233c.55-.164 1.163-.188 1.743-.14a4.5 4.5 0 0 0 4.486-6.336l-3.276 3.277a3.004 3.004 0 0 1-2.25-2.25l3.276-3.276a4.5 4.5 0 0 0-6.336 4.486c.091 1.076-.071 2.264-.904 2.95l-.102.085m-1.745 1.437L5.909 7.5H4.5L2.25 3.75l1.5-1.5L7.5 4.5v1.409l4.26 4.26m-1.745 1.437 1.745-1.437m6.615 8.206L15.75 15.75M4.867 19.125h.008v.008h-.008v-.008Z" />';break}return`
        <div class="carousel-item flex-none w-full md:w-1/3 p-4 transition-transform duration-500 ease-in-out">
            <div class="bg-white p-6 rounded-lg shadow-md flex flex-col items-center justify-center h-full border border-stone-100">
                <svg class="w-16 h-16 text-sky-900 mb-4" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">${n}</svg>
                <p class="text-base font-semibold text-gray-800 uppercase text-center">${t}</p>
            </div>
        </div>
    `}function te(){const e=document.getElementById("contacto-form"),t=document.getElementById("form-status"),n=document.getElementById("submit-btn");e&&e.addEventListener("submit",async r=>{r.preventDefault();const o=new FormData(e);t.classList.remove("hidden"),t.textContent="Enviando...",t.classList.remove("text-green-600","text-red-600"),t.classList.add("text-sky-900"),n.disabled=!0;try{const a=await fetch(e.action,{method:"POST",body:o}),s=await a.json();a.ok&&s.success?(t.textContent="¡Mensaje enviado con éxito! Recibirás una respuesta pronto.",t.classList.remove("text-sky-900","text-red-600"),t.classList.add("text-green-600"),e.reset()):(t.textContent=s.message||"Error al enviar el mensaje.",t.classList.remove("text-sky-900","text-green-600"),t.classList.add("text-red-600"))}catch(a){console.error("Error de conexión:",a),t.textContent="Error de conexión. Inténtalo más tarde.",t.classList.remove("text-sky-900","text-green-600"),t.classList.add("text-red-600")}finally{n.disabled=!1}})}function oe(){const e=document.getElementById("menu-toggle"),t=document.getElementById("mobile-menu"),n=t.querySelectorAll(".nav-link");if(!e||!t)return;function r(){t.classList.toggle("hidden"),document.body.classList.toggle("overflow-hidden")}e.addEventListener("click",r),n.forEach(o=>{o.addEventListener("click",()=>{t.classList.contains("hidden")||r()})})}function se(){const e=document.getElementById("horizontal-carousel"),t=document.getElementById("prev-btn"),n=document.getElementById("next-btn");if(!e)return;const r=Array.from(e.querySelectorAll(".carousel-item")),o=r.length,a=3;for(let i=0;i<a;i++){const v=r[o-a+i];e.prepend(v.cloneNode(!0))}for(let i=0;i<a;i++)e.appendChild(r[i].cloneNode(!0));let s=a;function l(){const i=e.querySelector(".carousel-item");return i?i.clientWidth:e.clientWidth/3}const c=l();e.style.transform=`translateX(${-s*c}px)`;function d(){const i=l();e.style.transition="transform 0.5s ease-in-out";const v=-s*i;e.style.transform=`translateX(${v}px)`,e.addEventListener("transitionend",function C(S){if(S.propertyName!=="transform")return;const b=l();s>=o+a?(s=a,e.style.transition="none",e.style.transform=`translateX(${-s*b}px)`):s<a&&(s=o+a-1,e.style.transition="none",e.style.transform=`translateX(${-s*b}px)`),e.removeEventListener("transitionend",C)},{once:!0})}function m(){s++,d()}function p(){s--,d()}n.addEventListener("click",m),t.addEventListener("click",p),setInterval(m,4e3),window.addEventListener("resize",()=>{const i=l();e.style.transition="none",e.style.transform=`translateX(${-s*i}px)`})}function ae(){const e=new IntersectionObserver((t,n)=>{t.forEach(r=>{r.isIntersecting&&r.target.classList.remove("opacity-0","translate-y-12")})},{threshold:.15,rootMargin:"0px 0px -10% 0px"});document.querySelectorAll(".scroll-reveal").forEach(t=>{e.observe(t)})}function ne(){const e=document.getElementById("service-modal"),t=document.getElementById("modal-content-wrapper"),n=document.getElementById("close-modal-btn");if(!e||!n)return;const r=()=>{e.classList.add("hidden"),t.classList.remove("scale-100","opacity-100"),t.classList.add("scale-90","opacity-0"),document.body.style.overflow=""};n.addEventListener("click",r),e.addEventListener("click",o=>{o.target===e&&r()}),document.addEventListener("keydown",o=>{o.key==="Escape"&&!e.classList.contains("hidden")&&r()}),document.querySelectorAll(".service-card").forEach(o=>{o.addEventListener("click",()=>{const a=o.getAttribute("data-service-id"),s=re(a);if(!s)return;let l="";s.subServices&&s.subServices.length>0&&(l=s.subServices.map(c=>`
        ...
        `).join("")),document.getElementById("modal-title").textContent=s.title,document.getElementById("modal-image").src=s.image,document.getElementById("modal-description").innerHTML=`<p class="text-gray-700 text-md">${s.description}</p>`,document.getElementById("modal-details").innerHTML=l,e.classList.remove("hidden"),document.body.style.overflow="hidden",setTimeout(()=>{t.classList.remove("scale-90","opacity-0"),t.classList.add("scale-100","opacity-100")},10)})})}function re(e){return{anexo24:{title:"ANEXO 24",image:k,description:"El Anexo 24 es crucial para el cumplimiento de obligaciones de comercio exterior. Aseguramos el adecuado registro y control de saldos.",subServices:[{icon:y,name:"ADMINISTRACIÓN DE ANEXO 24",description:"Se administra, audita y controla la obligación de demostrar los retornos de las mercancías importadas temporalmente a través de herramientas que cumplen con los requisitos ante la autoridad para fines de comercio exterior."},{icon:h,name:"AUDITORÍA ESPECIFICA AL ANEXO 24",description:"Se verifica que cumpla con las disposiciones legales y técnicas adecuadas para la correcta captura de la información de los catálogos base, la información productiva, la información aduanera y su descarga."}]},anexo30:{title:"ANEXO 30",image:A,description:"El Anexo 30 aplica a empresas certificadas IVA & IEPS. Gestionamos la supervisión y demostración del pago de IVA de importaciones temporales.",subServices:[{icon:y,name:"ADMINISTRACIÓN DEL ANEXO 30 PARA EMPRESAS CERTIFICADAS IVA & IEPS",description:"Se administra y supervisa la obligación de demostrar el pago del IVA de las importaciones temporales a través de sus retornos."},{icon:h,name:"AUDITORÍA ESPECIFICA AL ANEXO 30 PARA EMPRESAS CERTIFICADAS IVA & IEPS",description:"Se verifica que cumpla con las disposiciones legales y entrega de la información ante la autoridad para el cabal cumplimiento de la Certificación de IVA & IEPS, y así, evitar su cancelación o suspensión."}],details:null},cumplimiento:{title:"CUMPLIMIENTO",image:E,description:"Ofrecemos un paquete completo de servicios para asegurar la operación aduanera. Incluye auditorías y capacitación.",subServices:[{icon:L,name:"AUDITORÍAS PREVENTIVAS DE COMERCIO EXTERIOR",description:"Análisis profundo de sus operaciones, clasificación arancelaria y expedientes de comercio exterior para mitigar riesgos."},{icon:T,name:"CAPACITACIÓN ESPECIALIZADA",description:"Cursos y talleres a la medida para formar a su equipo en temas críticos de la legislación aduanera mexicana."},{icon:M,name:"COACHING Y GESTIÓN DE TRÁMITES",description:"Soporte directo para la resolución de requerimientos y la gestión de trámites (padrones, certificaciones, etc.) ante el SAT/AGA."}],details:null}}[e]}function ie(e){const t=e/7*2*Math.PI-Math.PI/2,n=50,r=50+n*Math.cos(t),o=50+n*Math.sin(t);return`left: ${r}%; top: ${o}%; transform: translate(-50%, -50%);`}function le(){const e=document.getElementById("rotating-text"),t=document.getElementById("rotating-description");if(!e||!t)return;let n=0;const r=4e3;function o(){const a=w[n];e.classList.add("opacity-0"),t.classList.add("opacity-0"),setTimeout(()=>{e.textContent=a.title,t.textContent=a.description,n=(n+1)%w.length,e.classList.remove("opacity-0"),t.classList.remove("opacity-0")},700)}o(),setInterval(o,r)}function ce(){const e=document.querySelectorAll("section[id]"),t=document.querySelectorAll(".nav-link"),n=64;t.forEach(o=>{o.addEventListener("click",a=>{a.preventDefault();const s=o.getAttribute("href"),l=document.querySelector(s);l&&window.scrollTo({top:l.offsetTop-n+1,behavior:"smooth"})})});function r(){const o=window.scrollY;let a="";e.forEach(s=>{const l=s.offsetTop-n,c=l+s.offsetHeight;o>=l&&o<c&&(a=s.getAttribute("id"))}),t.forEach(s=>{s.querySelector("img")||(s.classList.remove("text-sky-900","font-bold","border-b-2","border-sky-900"),s.classList.add("text-gray-700","hover:text-sky-900"),s.getAttribute("href")===`#${a}`&&(s.classList.add("text-sky-900","font-bold","border-b-2","border-sky-900"),s.classList.remove("text-gray-700")))})}window.addEventListener("scroll",r),r()}let g,x=0;function de(){if(typeof f>"u"||!f.length){console.error("Error: processSteps no está definido o está vacío.");return}const e=document.querySelectorAll(".process-indicator"),t=document.getElementById("process-step-title"),n=document.getElementById("process-step-description"),r=document.getElementById("process-step-icon"),o=document.querySelector("#process-wheel > div");if(!e.length)return;function a(){x=(x+1)%f.length,c(x,!1)}function s(){clearInterval(g),g=setInterval(a,5e3)}function l(){clearInterval(g),g=null}function c(d,m=!1){m&&g!==null&&l();const p=f[d];o.classList.add("opacity-0","translate-y-4"),setTimeout(()=>{t.textContent=p.title,n.textContent=p.description,r&&p.iconPath&&(r.src=p.iconPath),e.forEach(v=>v.classList.remove("bg-sky-700","ring-4","ring-sky-200"));const i=document.querySelector(`.process-indicator[data-step="${d}"]`);i&&i.classList.add("bg-sky-700","ring-4","ring-sky-200"),o.classList.remove("opacity-0","translate-y-4")},300),x=d}e.forEach(d=>{d.addEventListener("click",()=>{const m=parseInt(d.dataset.step);c(m,!0)})}),c(0,!1),s()}const me=64;function pe(){const e=document.querySelector("#app");if(!e)return;e.innerHTML=`
    ${K()}
    <main>
      ${F}
      ${X}
    ...
    ${ee()}
    ${Y}  `,se(),ne(),ce(),ae(),le(),te(),de(),oe();const t=document.getElementById("inicio");t&&window.scrollTo({top:t.offsetTop-me+1,behavior:"smooth"})}document.addEventListener("DOMContentLoaded",pe);
